...
import { Theme, Icon, Text, Link, Box, Em, Image, Span, Strong, List } from "@quarkly/widgets";
...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"cyberwiki/guide_beginners"} />
		<Helmet>
			<title>
				Guide for beginners
			</title>
			<meta name={"description"} content={"Information for a successful start for beginners"} />
			<meta property={"og:title"} content={"Guide for beginners"} />
			<meta property={"og:description"} content={"Information for a successful start for beginners"} />
			...
			<Components.Main>
				...
				>
					<Box quarkly-title="Article" max-width="52em" position="relative">
						...
						<Box margin="0px 0px 1em 0px" display="flex" align-items="center" justify-content="space-between">
						...
						/>
						<Text color="--textGray" margin="0 0 1.5em 0" font="--paragraph">
							<br />
							<Span
								white-space="normal"
								text-indent="0"
						...
						<Text sm-margin="0 0 1.5em 0" font="--paragraph" color="--textGray" margin="0 0 2.5em 0">
							<Span
								text-overflow="clip"
								hyphens="manual"
								color="--secondary"
				...
				<Box quarkly-title="Content" margin="2.5em 2.5em 2.5em 0em" sm-margin="0em .58em 0em 0em">
					<Components.Grid>
						<Components.Card>
							...
							<Override slot="Content" href="/cyberwiki/gans_of_night_city" background="--color-textDark url(https://uploads.quarkly.io/5fbbb8e92c4ef2001e329c56/images/team.png?v=2020-12-04T21:11:43.025Z) 0% 0% /cover no-repeat scroll padding-box" />
						</Components.Card>
						<Components.Card>
						...
						<Components.Card>
							...
							<Override slot="Content" background="--color-textDark url(https://uploads.quarkly.io/5fbbb8e92c4ef2001e329c56/images/pistols.png?v=2020-12-04T21:11:43.025Z) 0% 0% /cover no-repeat scroll padding-box" href="/cyberwiki/weapons" />
						</Components.Card>
					</Components.Grid>
				</Box>
			</Components.Main>
