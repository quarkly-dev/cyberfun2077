...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"cyberwiki/gans_of_night_city"} />
		<Helmet>
			<title>
				Gangs of Night city
			</title>
			<meta name={"description"} content={"Gangs guide"} />
			<meta property={"og:title"} content={"Gangs of Night city"} />
			...
			<Components.Main>
				...
				>
					<Box max-width="52em" position="relative" quarkly-title="Article">
						...
						<Text margin="0 0 .5em 0" sm-font="400 2.8em/1 BlenderPro, sans-serif" font="--header1" color="--secondary">
							<Em>
								Cyberpunk 2077 gangs
							</Em>
							{" "}Tyger Claws
				...
				<Box margin="2.5em 2.5em 2.5em 0em" sm-margin="0em .58em 0em 0em" quarkly-title="Content">
					<Components.Grid>
						<Components.Card>
