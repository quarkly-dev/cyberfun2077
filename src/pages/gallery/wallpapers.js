...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"gallery/wallpapers"} />
		<Helmet>
			<title>
				Wallpapers
			</title>
